...
local function generateScriptFormat(elementIndex)
    local generatedScript = [[-- Generated by Hydroxide's Upvalue Scanner: https://github.com/afyzone/Hydroxide

local aux = loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/afyzone/Hydroxide/revision/ohaux.lua"))()
